...
<html>
    ...
    <body>
        <button onclick="document.getElementById('id03').style.display='block'" style="width:auto;">Add Estates</button>
        ...
        <div id="id03" class="login-box">
          <form class="modal-content animate" method="post">
            ...
            <div class="button-form">
                ...
                <button type="submit" class="loginbtn">Add Estate</button>
